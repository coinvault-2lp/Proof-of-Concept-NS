...
# as he has lost his Hardware Token
#
#######################################

echo "-------------"
echo "Simulating the recovery process by Depositor"
echo "as he has lost his Hardware Token!"
echo "-------------"

echo "-------------"
echo "Depositor intimates Vault"
echo "to initiate recovery using Option 8"
echo "-------------"
...
echo "-------------"
echo "Simulating Recovery by Depositor Using " # [Customize this in accordance with Option]
echo "***Option 8*** of Provisonal Tx"
echo "(Corresponds to Option 9 in Figures)"
echo "-------------"
...
echo "[V] --> Partially Signed Recovery Tx --> [D]"
...
# [Customize This in accordance with Option]
RecovTxSigned=$(./bx input-set -c bx.cfg "[$VaultTokenSignatureRecov] [$VaultSignatureRecov] [$DepositorSignatureRecov] 8 [$ProvTxRedeemScript]" $RecovTx)
