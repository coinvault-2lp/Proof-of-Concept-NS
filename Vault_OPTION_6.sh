...
echo "-------------"
echo "Depositor also stores the Signatures generated using"
echo "his Private Key and Hardware Token for the Provisional Tx"
echo "to enable Option 6"
echo "-------------"
...
# as he lost his hardware token and 
# the Vault has disappeared and is
# not responding
#
#######################################
...
echo "as he lost his hardware token and "
echo "the Vault has disappeared and is not responding!"
echo "-------------"

echo "-------------"
echo "Depositor adds the pre-generated Signatures to the "
echo "Partially Signed Provisional Tx"
echo "-------------"
...
#######################################
#
# Depositor will broadcast ProvTx
...
echo "-------------"
echo "Simulating Recovery by Depositor " # [Customize This in accordance with Option]
echo "Using ***Option 6***of Provisonal Tx"
echo "(Corresponds to Option 7 in Figures)"
echo "-------------"
...
# [Customize This in accordance with Option]
RecovTxSigned=$(./bx input-set -c bx.cfg "[$DepositorSignatureRecov] 6 [$ProvTxRedeemScript]" $RecovTx)
